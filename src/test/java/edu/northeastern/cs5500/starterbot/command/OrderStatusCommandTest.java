...
public class OrderStatusCommandTest {
    ...
    void testBuildReplyEmbedWithOrders() {
        ...
        MessageEmbed actual = orderStatusCommand.buildReplyEmbed(orders);
        String expectedFieldName1 = "Your order at restaurant1 is preparing :cook:";
        String expectedFiledValue1 = "Ordered dishes: dish1, dish2";
        String expectedFieldName2 =
                "Your order at restaurant2 is being delivered by a driver :red_car:";
        String expectedFiledValue2 = "Ordered dishes: dish3";
        String expectedFieldName3 = "Your order at restaurant3 is delivered :thumbsup:";
